...
public class TWId {
	...
	public static boolean isRightId(String id) { /* 此id是傳參數 */
...
//		}
		...
		if(id.matches("[A-Z][12][0-9]{8}")) {
			char c1 = id.charAt(0);
			int a12 = letters.indexOf(c1) + 10;  //轉換為字母的代表數字
			int a1 = a12/10;  //字母的第一個數字是a1
			int a2 = a12%10;  //字母的第一個數字是a2
